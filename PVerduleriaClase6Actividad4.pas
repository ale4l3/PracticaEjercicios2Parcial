...
procedure cargarEtiquetas (var rg:RandomGenerator);
var
	i:integer;
	vNombre: array [1..15] of string = (' Ana ', ' Pedro ', ' Laura ', ' Marcos ', ' Sofia ', ' Juan ', ' Carla ', ' Diego ', ' Lucia ', ' Martín ', ' Valeria ', ' Pablo ', ' Natalia ', ' Andres ', ' Gabriela ');
begin
	for i:=1 to 15 do
